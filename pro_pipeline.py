...
def interactive_menu():
    ...
    while True:
        ...
        print("------------------------------------------------------------")
        print("── 1. PROJEKT A VSTUPY ─────────────────────────────────────")
        print("1  - Založit nový projekt (INPUT/, Prompts/, EDIT_PROJECT/)")
        print("12 - Přepnout na jiný projekt")
        print("13 - Nastavení pipeline (Whisper, hardware, FPS, AI provider)")
        print("\n── 2. NOVÝ SONG / SCÉNÁŘ / PLÁN ───────────────────────────")
        print("N  - Nový song bez klipů: scénář, rap výběr a generation prompty")
        print("4  - Analyzovat píseň (přepis, beaty a časování)")
        print("8a - Vygenerovat scénář pomocí AI")
        print("8b - Vygenerovat full_plan.txt pomocí AI")
        print("8c - Vygenerovat plán bez AI")
        print("\n── 3. NAČÍST A PŘIPRAVIT PLÁN ─────────────────────────────")
        print("2  - Rozparsovat full_plan.txt → timeline, prompty, metadata")
        print("3  - Vytvořit placeholdery pro chybějící média")
        print("\n── 4. RAP A LIPSYNC ───────────────────────────────────────")
        print("L  - Kompletní lipsync příprava (přepis → analýza → WAV segmenty)")
        print("5  - Přepsat rap klipy")
        print("U  - Znovu najít textové kotvy po ruční úpravě alignmentu")
        print("6  - Doladit tempo rap klipů podle songu")
        print("7  - Zarovnat rap timeline podle skutečného textu v songu")
        print("I  - Vložit hotové lipsync segmenty do timeline")
        ...
        print("\n── 6. VALIDACE A RENDER ───────────────────────────────────")
        print("9  - Validovat projekt před renderem")
        print("10 - Vyrenderovat video s rapem")
        print("R  - Vyrenderovat video bez rapu (Character mód)")
        print("11 - Spustit celý proces od začátku po render")
        print("C  - Spustit celý proces bez rapu")
        print("\n── 7. QA A POSTPRODUKCE ───────────────────────────────────")
        print("Q  - Vytvořit automatický QA summary")
        print("G  - Zobrazit render registry")
        print("A  - Spustit A/B render a QA porovnání")
        print("J  - Exportovat social formáty")
        print("K  - Vygenerovat thumbnail kandidáty")
        print("\n── 8. UKONČENÍ A NÁPOVĚDA ─────────────────────────────────")
        print("E  - Spravovat staré rendery v EXPORT/")
        print("H  - Zobrazit podrobnou nápovědu")
        print("0  - Konec")
        print("============================================================")
